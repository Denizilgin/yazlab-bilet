									...
									<div class="screen-home__location" style="margin-top: 110px;">
										...
										<div class="input-wrap">
											...
											<div style="margin-top: 30px; text-align: center" >
												...
												<br>
												<br>
												<input type="date" id="date" name="trip-start" value="xxxx-03-20" min="2024-01-01"
													max="2024-12-31" />
											</div>
											<div style="margin-top: 10px; text-align: center">
											<input type="checkbox" id="redirectCheckbox"><br> <label for="redirectCheckbox"> Gidiş - Dönüş
											</label>
											</div>
										</div>
									...
									<div class="screen-bus__name-time-seat">
										...
										<div class="screen-bus__time-wrap">
											<div class="screen-bus__time">
												...
												<!-- VERİTABANINDAN ÇEKİLEN KALKIŞ SAATİ GELİCEK-->
										...
										<div class="screen-bus__seat-wrap">
											<div>
												<span class="screen-bus__count" id="seat">26</span>
												<!-- VERİTABANINDAN ÇEKİLEN KOLTUK SAYISI GELİCEK-->
												Seats Available
											</div>
										</div>
									</div>
										...
										<div class="screen-bus__rating-price-row">
											<div class="screen-bus__rating">
												<ul class="screen-bus__rating-row">
													<li>
														<figure><img src="https://i.ibb.co/pxtdTrM/star.png"></figure>
													</li>
													<li>
														<figure><img src="https://i.ibb.co/pxtdTrM/star.png"></figure>
													</li>
													...
													<li>
														<figure><img src="https://i.ibb.co/WPLcC1D/star-grey.png"></figure>
													</li>
												</ul>
											</div>
