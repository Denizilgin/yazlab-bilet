    ...
    <body>
        <table>
            ...
            foreach ($query->getResult() as $row) {
                ?>
                <tr
                    onclick="goToSeferDetay('<?php echo $row->KalkisNoktasi; ?>', '<?php echo $row->VarisNoktasi; ?>', '<?php echo $row->Tarih; ?>', '<?php echo $row->KoltukSayisi; ?>', '<?php echo $row->KalkisSaati; ?>', '<?php echo $row->Plaka; ?>', '<?php echo $row->SeferID; ?>')">
                    <td>
                        <?php echo $row->KalkisNoktasi; ?>
                    </td>
                    <td>
                        <?php echo $row->VarisNoktasi; ?>
                    </td>
                    <td>
                        <?php echo $row->Tarih; ?>
                    </td>
                    <td>
                        <?php echo $row->KoltukSayisi; ?>
                    </td>
                    <td>
                        <?php echo $row->KalkisSaati; ?>
                    </td>
                    <td>
                        <?php echo $row->Plaka; ?>
                    </td>
